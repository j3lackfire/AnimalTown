...
public abstract class AbstractTargetFollower : MonoBehaviour
{
	...
	void FixedUpdate() {
		...
		if (updateType == UpdateType.FixedUpdate || updateType == UpdateType.Auto && target != null && (target.GetComponent<Rigidbody>() != null)) {
	...
	void LateUpdate() {
		...
		if (updateType == UpdateType.LateUpdate || updateType == UpdateType.Auto && target != null && (target.GetComponent<Rigidbody>() == null )) {
			FollowTarget(Time.deltaTime);
		}
	}
